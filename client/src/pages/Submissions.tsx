...
const SubmissionPage: FC<SubmissionProps> = ({}) => {
    return (
        <div className="p-2 flex flex-col">
            <h1 className="text-xl text-green-600">Cocktail Submission</h1>
            <span className="py-2 text-sm">Fill out the form below to have your own cocktail creation submitted for review. Your cocktail should make use of locally inspired ingredients that make your drink unique. After submitting, your submission will be reviewed to ensure quality and saftey standards. Once approved we will send you an email to review the final post before it goes on the site.</span>
